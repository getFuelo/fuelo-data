...
SPECS['ap8-gipuzkoa-west'] = {'ref': 'AP-8',
 'additionalRefs': ['AP-1;AP-8', 'AP-8;AP-1'],
 'bbox': [43.17, -2.47, 43.32, -2.12],
 'tariffFamily': 'ap8-ap1-full',
 'tollId': 'es-ap8-gipuzkoa',
 'expectedDirectedFares': 28,
 'filterFareZones': ['Eibar',
                     'Elgoibar',
                     'Itziar',
                     'Zestoa – Zumaia',
                     'Zarautz Oeste',
                     'Zarautz Barrera (Donostia)'],
 'tariffZoneAliases': {'Eibar': 'EIBAR',
                       'Elgoibar': 'ELGOIBAR',
                       'Itziar': 'ITZIAR',
                       'Zestoa – Zumaia': 'ZUMAIA',
                       'Zarautz Oeste': 'ZARAUTZ-OESTE',
                       'Zarautz Barrera (Donostia)': 'DONOSTIA'},
 'excludeSelfPairs': True,
 'accesses': [('EIBAR', 'osm-review-6929503', 45856790, 6929503, False, (429379683, 0), (429379683, 0)),
              ('ELGOIBAR',
               'osm-review-834673',
               1491970945,
               13672799202,
              ...
              ('ITZIAR',
               ...
               (803024884, 3),
               (803024884, 3)),
              ('ZUMAIA', 'osm-review-27015741', 4713139, 27015759, False, (4713139, 3), (713019387, 9))],
 # Itziar's signed toll approaches include N-634-D and service lanes.
 'extraCoverageWays': [4413851, 297017030, 803024884, 917591312, 35063578, 35063576, 35063577, 803024878, 803024874, 917591303, 917591302, 4413846, 803024882, 803024883, 803024879, 495606814, 917591311],
 'logicalAccesses': [('ZARAUTZ-OESTE',
                      (25310914, 275715018, 275714506),
                      (25310915, 275714819, 275714943)),
                     ('DONOSTIA', (419083804, 275715010, 275705785), (4493086, 275715013, 2349925522))]}

SPECS['ap8-bizkaia'] = {'ref': 'AP-8',
 'bbox': [43.16, -2.8, 43.25, -2.49],
 'tariffFamily': 'ap8-ap1-full',
 'tollId': 'es-ap8-bizkaia',
 # Arabat explicitly publishes zero for Iurreta–Abadiño; Bidegi leaves it blank.
 'expectedDirectedFares': 20,
 'filterFareZones': ['Acceso Oeste',
                     'Amorebieta-Etxano',
                     'Iurreta',
                     'Abadiño',
                     'Ermua'],
 'tariffZoneAliases': {'Acceso Oeste': 'OESTE',
                       'Amorebieta-Etxano': 'AMOREBIETA',
                       'Iurreta': 'IURRETA',
                       'Abadiño': 'ABADINO',
                       'Ermua': 'ERMUA'},
 'zoneAliases': {'AMOREBIETA-oeste': 'AMOREBIETA',
                 'IURRETA-oeste': 'IURRETA',
                 'ABADINO-oeste': 'ABADINO'},
 'orderedZones': ['OESTE', 'AMOREBIETA', 'IURRETA', 'ABADINO', 'ERMUA'],
 'accesses': [],
 'extraCoverageWays': [69569767,
                       205281765,
                       314763252,
                       314764195,
                       419723860,
                       ...
                       436467200,
                       494698435],
 'logicalAccesses': [('OESTE',
                      (205281765, 243084087, 1746829997),
                      (69569767, 31233166, 5630306311)),
                     ('AMOREBIETA',
                      (69562663, 832526350, 832526298),
                      (69852232, 835110709, 832526324)),
                     ('AMOREBIETA-oeste',
                      (69852214, 835110655, 832526293),
                      (41293650, 6130894652, 504931836)),
                     ('IURRETA',
                      (1490210895, 667983147, 667983143),
                      (1490210899, 6986879623, 588166295)),
                     ('IURRETA-oeste',
                      (52585032, 668016357, 12896457684),
                      (1393219094, 668016362, 12896457692)),
                     ('ABADINO',
                      (314763101, 5580427399, 4291267232),
                      (461222787, 4864301681, 4567573393)),
                     ('ABADINO-oeste',
                      (169231148, 4864301677, 1668079075),
                      (583714514, 1668079070, 5580427397)),
                     ('ERMUA',
                      (451119344, 5335035111, 3252006686, True),
                      (451119344, 5335035111, 5912416866))]}

SPECS['ap8-gipuzkoa-east'] = {'ref': 'AP-8',
 'additionalRefs': ['AP-1;AP-8', 'AP-8;AP-1', 'AP-1;AP-8;E-15'],
 'bbox': [43.27, -1.925, 43.34, -1.81],
 'tariffFamily': 'ap8-east',
 'tollId': 'es-ap8-gipuzkoa',
 'expectedDirectedFares': 12,
 'zoneAliases': {'OIARTZUN-este':'OIARTZUN'},
 'bidirectionalRows': True,
 'filterFareZones': ['Donostia - SS. E / Hernani / Astigarraga / Lasarte',
                     'Oiartzun',
                     'Irun M/O',
                     'Irun Ventas',
                     'Behobia'],
 'tariffZoneAliases': {'Donostia - SS. E / Hernani / Astigarraga / Lasarte': 'DONOSTIA-ESTE',
                       'Oiartzun': 'OIARTZUN',
                       'Irun M/O': 'IRUN-OESTE',
                       'Irun Ventas': 'IRUN-VENTAS',
                       'Behobia': 'BEHOBIA'},
 'accesses': [],
 'extraCoverageWays': [25712516, 1455540353, 1459560205, 1528583056],
 'logicalAccesses': [('GI20', (31233054,13793505493,563708), None), ('OIARTZUN-este', (1349609781,278826601,9464504594), (25710689,13977711720,278535218)),
                     ('DONOSTIA-ESTE',
                      (31237370, 783791631, 347310341),
                      (48123875, 611764928, 611771494)),
                     ('OIARTZUN',
                      (25556191, 278549802, 9464504594),
                      (997126261, 2814306535, 278535218)),
                     ('IRUN-OESTE',
                      (1459560205, 280361615, 13386509529),
                      (25712516, 13348502065, 280352549)),
                     ('IRUN-VENTAS',
                      (25713274, 280361712, 280474584),
                      (25713273, 280361681, 280474588)),
                     ('BEHOBIA',

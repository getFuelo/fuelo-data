...
ROOT=Path(__file__).resolve().parents[2];parser=argparse.ArgumentParser();parser.add_argument('family',choices=['ap41','ap71','ap36','ap7-cartagena-vera']);args=parser.parse_args();family=args.family
